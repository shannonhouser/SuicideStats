...
Furthermore, it may be further explore how these factors have changed over time and if the changes are statistically significant. For example, we may explore whether the total number of suicides in the US has significantly changed between 1985 and 2016. 
