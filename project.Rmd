...
subtitle: "An anaylsis of critical variables"
...
We wanted to fit a linear model to decide which factors were the best when predicting suicide rates across the world. We created a linear model and used the step function to see which were the best variables for predicting sucide rates. We determined that sex, age, gdp per capita, and hdi per capita were the best predictors of suicide rate. 
